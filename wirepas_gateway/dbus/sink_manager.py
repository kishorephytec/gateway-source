...
class Sink:
    ...
    def send_data(
        ...
        self.logger.info("The dest-addr : %2X ",dst )
        self.logger.info("The src-ep : %2X ",src_ep )
        self.logger.info("The dst-ep : %2X ",dst_ep )
        self.logger.info("The qos : %2X ",qos )
        self.logger.info("The initial_time : %2X ",initial_time )
        self.logger.info("The data : %s ",data )
        self.logger.info("The csma_ca : %2X ",is_unack_csma_ca )

        self.logger.info("The hop-limit : %2X ",hop_limit )
        try:
