...
class TransportService(BusClient):
    ...
    def _on_send_data_cmd_received(self, client, userdata, message):
        ...
        try:
            ...
            self.logger.info("The Complete packet is : %s ",message.payload.hex())
            self.logger.info("Decoded data : %s ",request)
        ...
        self.logger.info("Downlink traffic: %s | %s", sink_id, request.req_id)


        self.logger.info("The dest-address is : 0%2X \n",request.destination_address)
        self.logger.info("The src-ep is : 0%2X \n",request.source_endpoint)
        self.logger.info("The dest-ep is : 0%2X \n",request.destination_endpoint)
        self.logger.info("The qos is : 0%2X \n",request.qos)
        self.logger.info("The initial_delay_ms is : 0%2X \n",request.initial_delay_ms)
        self.logger.info("The payload is : %s \n",request.data_payload)
        self.logger.info("The csma_ca is : 0%2X \n",request.is_unack_csma_ca)
        self.logger.info("The hop-limit is : 0%2X \n",request.hop_limit)
